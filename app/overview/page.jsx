...
const OverviewOrder = () => {
  ...
  const states = useSelector((state) => state.order)
  console.log(states);
  const getState = () => {
          ...
          <div className="overview-item">
            ...
            <div className="overview-item-card overview-item__stay">
              <div className="overview-item-image overview-item__stay-image">
                <img src="https://cdn.weski.com/prod/rentable_images/availpro/p_v/14544.AHL14S/media_PV_WINTER_2023_AHL14S_800x600_AHL_95018_43.jpg_thumb_720.webp_thumb_720.webp" alt="" />
              </div>

              <div className="overview-item__stay-text">
                <div className="overview-item__stay-name">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus aliquid totam iste beatae? Nobis, dolor! Facere perferendis eligendi dicta sunt?
                </div>
